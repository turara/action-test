...
exports.pullRequestsMetrics = void 0;
const rest_1 = __nccwpck_require__(5375);
const verbose_1 = __nccwpck_require__(9909);
const date_1 = __nccwpck_require__(6154);
const baseHeaders = {
...
const defaultListPullRequestsOption = {
    direction: 'desc',
    // limit: undefined,
...
const listPullRequests = (owner, repo, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let page = 1;; page++) {
        ...
        const response = yield octokit.request('GET /repos/{owner}/{repo}/pulls', Object.assign(Object.assign(Object.assign({ owner,
            repo, headers: Object.assign({}, baseHeaders) }, defaultListPullRequestsOption), options), { page }));
...
const pullRequestsMetrics = (owner, repo, baseBranches = [], options) => __awaiter(void 0, void 0, void 0, function* () {
    const cycleOptions = Object.assign(Object.assign({}, defaultCycleOptions), options === null || options === void 0 ? void 0 : options.cycleOptions);
    const period = (0, date_1.getPeriod)(cycleOptions.startDate, cycleOptions.unit, cycleOptions.gmt);
    if (verbose_1.isVerbose) {
        // eslint-disable-next-line no-console
        console.log(`[pullRequestsMetrics] period: ${period.startAt.toISOString()} - ${period.endAt.toISOString()}`);
    }
    const prs = yield listPullRequests(owner, repo, options === null || options === void 0 ? void 0 : options.listPullRequestsOptions);
    const targetPrs = prs
        .filter((pr) => {
        ...
        if ((0, date_1.isInvalidDate)(mergedAt)) {
            return false;
        }
    ...
    if (verbose_1.isVerbose) {
        // eslint-disable-next-line no-console
        console.log('[pullRequestsMetrics] targetPrs:', JSON.stringify(targetPrs.slice(0, Math.min(targetPrs.length, 100)).map(extractPullRequest), null, 2));
    }
    return {
        cycleOptions,
...
exports.pullRequestsMetrics = pullRequestsMetrics;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const unit = core.getInput('cycle-unit');
            const gmt = core.getInput('gmt');
            const branches = core
                .getInput('branches')
                .split(',')
            ...
            if (verbose) {
                (0, verbose_1.setVerbose)();
            }
            const metrics = yield (0, github_1.pullRequestsMetrics)(owner, repo, branches, {
                cycleOptions: {
                    startDate,
                    unit,
                    gmt,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getPeriod = exports.isInvalidDate = void 0;
const isInvalidDate = (date) => Number.isNaN(date.getTime());
exports.isInvalidDate = isInvalidDate;
const getPeriod = (startDate, unit, gmt = 'GMT') => {
    const startAt = new Date(`${startDate} 00:00:00 ${gmt}`);
    if ((0, exports.isInvalidDate)(startAt)) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setVerbose = exports.isVerbose = void 0;
// eslint-disable-next-line import/no-mutable-exports
exports.isVerbose = false;
const setVerbose = () => {
    exports.isVerbose = true;
};
